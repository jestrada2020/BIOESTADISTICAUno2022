...
Los cuantiles son conjuntos de valores (ó puntos)
que dividen el conjunto de datos en grupos de igual tamaño.
Por ejemplo, en la figura, hay nueve valores que dividen el conjunto
de datos . Esos nueve valores son cuantiles



```{r Est1,echo=FALSE, fig.cap="Ejemplo Cuantiles", out.width="60%"}
knitr::include_graphics("/home/john/Documentos/DOC-RMD-CLASESUCESV1/BIOestadisticaUno2022/images/GraficaCuantiles.jpg")
```
...
```{r Est2,echo=FALSE, fig.cap="Ejemplo Cuartiles", out.width="60%"}
knitr::include_graphics("/home/john/Documentos/DOC-RMD-CLASESUCESV1/BIOestadisticaUno2022/images/FiguraCuartiles.jpg")
```
...
### Críterio para determinar datos **atípicos**


Un dato atípico es aquella observación que está muy lejos del resto de los datos.
Un valor se dice atípico si es mayor que $Q_{3}+1.5(Q_{3}-Q_{1})$, o es menor que
$Q_{1}-1.5(Q_{3}-Q_{1})$
...
<center>![](/home/john/Documentos/DOC-RMD-CLASESUCESV1/BIOestadisticaUno2022/images/GRAFICAcajaybigotes12.jpg){width=85%}</center>
...
boxplot(Pc,
        ...
        col="skyblue",
        horizontal = TRUE)
stripchart(Pc, method = "jitter", pch = 19, add = TRUE, col = "blue")
```


<!-- Pagina de referencia - BUSCAR https://r-coder.com/boxplot-en-r/ -->
